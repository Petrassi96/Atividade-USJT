...
public class Tela extends JFrame implements ActionListener
{
    ...
    private JTextField txtValorHora, txtHoras, txtValorTarefa, txtTarefas, txtSalario, txtComissao;

    private JLabel lblNome, lblSobrenome, lblCpf;
    private JLabel lblValorHora, lblHoras, lblValorTarefa, lblTarefas, lblSalario, lblComissao;
    private JLabel lblSalarioMensalista, lblSalarioComissionado, lblSalarioHorista, lblSalarioTarefeiro;
